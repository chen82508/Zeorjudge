...
class BigNum {
	...
	public :
		...
		BigNum operator- ( BigNum x ) {
			...
			while ( !ans.num[ans.digit] && ans.digit >= 0 ) ans.digit -- ;
		...
		void print () {
			...
			for ( int i = digit - 1 ; i >= 0 ; i -- ) cout << num[i] ;
